// ============================================================================
// FILE: src/crm/defaultContent.js  (REPLACE; adds seo + theme defaults)
// ============================================================================
export const defaultContent = {
  site:{ name:"Meadow Ridge Pet Lodge", logoUrl:"/logo.svg", phone:"(555) 555-0123", email:"hello@happypaws.example", address:"123 Wag Street, Pawville, USA", socials:{instagram:"#",facebook:"#"} },
  seo: {
    ...
    pages: {
      home:        { title: "Meadow Ridge Pet Lodge – Pet Day Care & Boarding", description: "Safe, clean, and joy-filled experiences for dogs and their humans.", image: "" },
      ...
      about:       { title: "About • Happy Paws", description: "Meet the team, see our mission, reviews, and gallery.", image: "" },
  ...
  home:{ heroImages:["https://images.unsplash.com/photo-1558944351-c0d7e269024d","https://images.unsplash.com/photo-1518020382113-a7e8fc38eac9","https://images.unsplash.com/photo-1543466835-00a7907e9de1"],
    mission:"Safe, clean, and joy-filled experiences for dogs and their humans.",
    missionTeasers:[{title:"Splash Parks",excerpt:"Indoor & outdoor water fun.",link:"/services#splash"},{title:"Overnight Stays",excerpt:"Cozy suites & 24/7 care.",link:"/services#overnight"},{title:"Training",excerpt:"From puppy to pro.",link:"/training"}],
    quickLinks:[{label:"Mission",href:"/about#mission"},{label:"Reviews",href:"/about#reviews"},{label:"FAQs",href:"/about#faqs"}] },
  services:[
  ...
  about:{ team:[{name:"Alex Rivera",role:"General Manager",photo:"",bio:"10+ years in pet care."},{name:"Sam Lee",role:"Head Trainer",photo:"",bio:"CPDT-KA & AKC evaluator."}],
    mission:"We deliver safe, enriching, and transparent care that puts canine welfare first.",
    different:["Transparent webcams and report cards.","Science-based handling & certifications.","Thoughtful playgroup curation."],
    gallery:["https://images.unsplash.com/photo-1558944351-c0d7e269024d","https://images.unsplash.com/photo-1543466835-00a7907e9de1","https://images.unsplash.com/photo-1507149833265-60c372daea22"],
    reviews:[{name:"Jordan",text:"Our pup sprints to the door every time!"},{name:"Morgan",text:"Training changed our daily life."}],
    faqs:[{q:"What vaccines are required?",a:"Rabies, DHPP, and Bordetella. Proof required."},{q:"Do you separate by size?",a:"Yes, by size and play style with supervisor ratios."}]
  },
  contact:{ general:"Questions? Call, email, or use the form.", reservations:"Use the reservation form and we’ll confirm availability by email." },
  jobs:{ intro:"Join a mission-driven team that puts dogs first.", positions:[{title:"Daycare Attendant",description:"Supervise groups, clean & care.",applyLink:"#"}, {title:"Groomer",description:"Full-service grooming experience.",applyLink:"#"}]},
